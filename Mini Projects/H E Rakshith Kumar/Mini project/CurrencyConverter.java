package Curreny;
	...
	double doller,pond,euro,yen,ringgit,rupiah,won,dong,lkr,npr;
	...
	{
	  doller=Amount/82.8;
	System.out.println("Converting"+Amount+"Rupees into Doller: "+String.format("%.2f",doller)+ "  Dollers");
	break;
	}
	case 2:
	{
	...
	{
	 rupiah =Amount/0.005;
	System.out.println("Converting"+Amount+"Rupees into Doller: "+String.format("%.2f",rupiah)+ "  Rupiah");
	break;
	}
