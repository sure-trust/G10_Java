...
JRadioButton male, female;
 ButtonGroup genderGroup; CreateAccount () {
...
female.setBounds (500,260,150,30); female.setBackground (Color.WHITE);
...
String pcode=textPcode.getText();
...
String query="insert into form (name, Fname) values ('"+name+"','"+fname+"',)";
