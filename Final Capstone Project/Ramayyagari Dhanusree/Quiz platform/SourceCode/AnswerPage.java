...
public class AnswerPage extends JFrame implements ActionListener {

    JButton finish;
    AnswerPage(String name,int score)
    {
        // Background
        ...
        //picture
        ImageIcon icon=new ImageIcon(ClassLoader.getSystemResource("Icon/answer.png"));
